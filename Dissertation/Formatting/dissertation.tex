...
% Make per-chapter bibliography heading match the TOC entry ("References").
\renewcommand{\bibname}{References}
\renewcommand{\bibsection}{\section*{\bibname}}
% Each entry single-spaced internally; double-space gap between entries.
% (\singlespacing is applied around \bibliography in each chapter wrapper.)
...
\usepackage{subcaption}       % New Solar Panel essay uses subfigure environment
\usepackage{float}
\usepackage{placeins}
...
\usepackage{bbm}
\usepackage{bm}
\usepackage{dsfont}           % \mathds{1} used in solar/energy summary tables
...
\usepackage[colorlinks=true, linkcolor=black, citecolor=black,
            urlcolor=black, filecolor=black, anchorcolor=black,
...
\newcommand{\nb}[1]{\textcolor{black}{NB[#1]}}
\newcommand{\aruna}[1]{\textcolor{black}{Aruna[#1]}}
\chardef\mhyphen="2D
...
\newenvironment{IEEEbiography}[2][]{\setbox0\vbox\bgroup}{\egroup}
\providecommand{\titlepgskip}{}
\providecommand{\history}[1]{}

% ========================== CAS CLASS STUBS ===================================
% Commands from cas-sc.cls (Energy Economics Submission)
...
\providecommand{\niranjan}[1]{}
% highlights and keywords environments (absorb content)
\newenvironment{highlights}{\setbox0\vbox\bgroup}{\egroup}
\newenvironment{keywords}{\setbox0\vbox\bgroup}{\egroup}
...
\newcommand{\SuppressTitlePage}{%
  \renewenvironment{titlepage}{\setbox0=\vbox\bgroup}{\egroup}%
}
...
% --- Copyright Page (no number shown, not counted) ---
\input{front_matter/copyright}

% --- Approval / Signature Page (preliminary numbering starts here at "ii") ---
% Set counter to 1 so the (unnumbered) copyright page ships as page 1
% and the next \clearpage (at the top of approval.tex) increments to 2.
\setcounter{page}{1}
...
\include{chapters/ch5_jmp}

% --- Chapter 2: Solar Panel ---
\include{chapters/ch2_solar}

% --- Chapter 3: AI Power Grids (Energy Economics Submission) ---
\include{chapters/ch3_ai_power}

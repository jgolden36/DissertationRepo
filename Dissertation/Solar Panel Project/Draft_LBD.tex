...
\quad Constant ($\gamma^{0}_{poly}$) & 7.864 & (0.370) \\
\quad Experience ($\gamma^{s,e}_{poly}$) & -10.068 & (0.257) \\
\quad Input price ($\gamma^{s,i}_{n}$) & \\
\quad\quad Polysilicon price & 0.144 & (0.045) \\
\underline{\textit{(ii) Thin-Film Firms:}} \\
\quad Constant ($\gamma^{0}_{thin}$) & 5.000 & (0.163) \\
\quad Experience ($\gamma^{s,e}_{thin}$) & -6.311 & (0.438) \\
\underline{\textit{(iii) Common Variables:}} &  \\
\quad Exporting ($\gamma_m^{ex}$) & \\
\quad\quad EU & 3.627 & (0.256) \\
\quad\quad India & 4.117 & (1.510) \\
\quad\quad Japan & -4.270 & (0.148) \\
\quad\quad US & 1.849 & (0.993) \\
\quad\quad ROW & 0.746 & (0.240) \\
\quad Other state variables ($\gamma^{s,o}$) &  \\
\quad\quad SOE & 3.882 & (0.860) \\
\quad Trend ($\gamma^{trend}$) & \\
\quad\quad Pre-2010 & -0.953 & (0.019) \\
\quad\quad Post-2010 & -0.752 & (0.038) \\
\quad Scale ($\gamma^{scale}$) & 5.960 & (0.155) \\
\quad SD of shocks ($\sigma^{\omega}$) & 0.169 & (0.093) \\
\bottomrule
\end{tabularx}
\begin{tablenotes}
...
\quad Sigma phi ($\sigma_{\phi}$) & 1.000 & (0.000) \\
\quad Phi bar ($\bar{\phi}$) & -2.148 & (0.000) \\
\multicolumn{3}{l}{\textit{Entry Cost:}} \\
\quad c-Si technology ($\kappa_{1}$) & & \\
\quad\quad 2000-2009 & 5.217 & (0.027) \\
\quad\quad 2010+& 3.467 & (0.000) \\
\quad Thin-film technology ($\kappa_{2}$) & & \\
\quad\quad 2011+& 3.711 & (0.008) \\
\bottomrule
\end{tabularx}
\begin{tablenotes}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{Figures/ModelFitProd.png}
    \caption{Model fit specifically for production.}
    \label{fig:placeholder}
\end{figure}

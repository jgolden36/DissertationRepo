...
The remainder of the paper proceeds as follows. Section 2 describes the solar panel industry and the data. Section 3 presents the model. Section 4 outlines the estimation strategy. Section 5 reports the estimation results. Section 6 presents the counterfactual analysis. Section 7 concludes.
...
% \begin{landscape}
% \input{Figures/figure_LBD_illustrative.tikz}
% \end{landscape}
% \begin{figure}
...
Consumers generally prefer c-Si solar panels over thin-film solar panels, with EU consumers demonstrating the strongest preference. This finding is consistent with the higher efficiency and durability of c-Si panels documented in Section 2. 
